...
@rem 
@rem Copyright (c) 2018, DEMCON advanced mechatronics
...
.qhcp project file in %BUILDDIR%/qthelp, like this:
	echo.^> qcollectiongenerator %BUILDDIR%\qthelp\xlab.qhcp
	echo.To view the help file:
	echo.^> assistant -collectionFile %BUILDDIR%\qthelp\xlab.ghc
	goto end
)
